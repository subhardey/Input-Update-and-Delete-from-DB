					...
					success: function(result)
							{
								...
								if (result.data=='validity') {
									...
									console.log('in if');
									$('#errorMsg').append(`<p>Email was already used! Use another.</p>`);
									...
									// $('#errorMsg').empty();
									console.log('in else');
									$('#errorMsg').append(`<p>Document Submitted!!</p>`);
...
// setTimeout(function(){
// 		 $('.inputBox').val("");
//     	$('.radioBtn').prop('checked', false); }, 300);  //<-- removes fields after saving --
